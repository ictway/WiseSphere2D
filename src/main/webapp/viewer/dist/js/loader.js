...
(function() {
	...
	raw = true; //test...BY_JIN
	
	if (!raw) {
//		document.write('<scr' + 'ipt type="text/javascript" src="../build/ol.js"></scr' + 'ipt>');
		document.write('<scr' + 'ipt type="text/javascript" src="dist/js/' + scriptId + '.min.js"></scr' + 'ipt>');
		document.write('<scr' + 'ipt type="text/javascript" src="dist/js/function.min.js"></scr' + 'ipt>');
		document.write('<scr' + 'ipt type="text/javascript" src="dist/js/script.min.js"></scr' + 'ipt>');
	} else {
//		window.CLOSURE_NO_DEPS = true; // we've got our own deps file
//		document.write('<scr' + 'ipt type="text/javascript" src="../closure-library/closure/goog/base.js"></scr' + 'ipt>');
//		document.write('<scr' + 'ipt type="text/javascript" src="../build/ol-deps.js"></scr' + 'ipt>');
//		document.write('<scr' + 'ipt type="text/javascript" src="' + scriptId + '-require.js"></scr' + 'ipt>');
		document.write('<scr' + 'ipt type="text/javascript" src="dist/js/' + scriptId + '.js"></scr' + 'ipt>');
		document.write('<scr' + 'ipt type="text/javascript" src="dist/js/function.js"></scr' + 'ipt>');
		document.write('<scr' + 'ipt type="text/javascript" src="dist/js/script.js"></scr' + 'ipt>');
	}
//	document.write('<scr' + 'ipt type="text/javascript" src="' + scriptId + '.js"></scr' + 'ipt>');
}());

// 개발용 SERVER_URL 추가...BY_JIN
var SERVER_URL = "./proxy.jsp?url=http://192.168.0.6:8080/ws";