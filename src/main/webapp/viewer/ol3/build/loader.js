...
(function() {
	...
	var contextPat = window.location.pathname.substring(0, window.location.pathname.indexOf("/",2));
	if (!raw) {
//		document.write('<scr' + 'ipt type="text/javascript" src="../build/ol.js"></scr' + 'ipt>');
		document.write('<scr' + 'ipt type="text/javascript" src="'+contextPat+'/viewer/ol3/build/ol.js"></scr' + 'ipt>');
	} else {
//		window.CLOSURE_NO_DEPS = true; // we've got our own deps file
//		document.write('<scr' + 'ipt type="text/javascript" src="../closure-library/closure/goog/base.js"></scr' + 'ipt>');
//		document.write('<scr' + 'ipt type="text/javascript" src="../build/ol-deps.js"></scr' + 'ipt>');
//		document.write('<scr' + 'ipt type="text/javascript" src="' + scriptId + '-require.js"></scr' + 'ipt>');
		document.write('<scr' + 'ipt type="text/javascript" src="'+contextPat+'/viewer/ol3/build/ol-debug.js"></scr' + 'ipt>');
	}
	document.write('<scr' + 'ipt type="text/javascript" src="dist/js/loader.js?id=' + scriptId + '"></scr' + 'ipt>');
}());
