...
public enum GMLVersion {
    ...
    /** PBF 2.1 versions (2.1.0) */
    PBF_2( "https://www.mapbox.com/mapbox-gl-js/style-spec/", "2.1", "2.1.0" ),
    /** GeoJSON */
    GEOJSON_1( "https://tools.ietf.org/html/rfc7946", "1.0", "1.0.0" );
     ...
     * @return the mime type (deprecated style), never <code>null</code>
     */
    public void setMimeTypeOldStyle(String mimeTypeOld) {
        this.mimeTypeOld = mimeTypeOld;
    }
