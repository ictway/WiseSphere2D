...
import org.deegree.sqldialect.oracle.OracleDialectProvider;
...
public class SQLDialectManager extends AbstractBasicResourceManager {
    ...
    public synchronized SQLDialect create( String connId )
        ...
        if ( typeToDialectProvider == null ) {
            ...
            try {
            	//@@ictway
            	//if (connId.toUpperCase().contains("ORACLE")) {
            		Type sqlTypeOracle = Type.Oracle;
            		OracleDialectProvider providerOracle = new OracleDialectProvider();
            		typeToDialectProvider.put( sqlTypeOracle, providerOracle );
            	//}
            	//@@
