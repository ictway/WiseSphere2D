...
public class HtmlInputBBox extends UISelectOne {
    ...
    private static enum AdditionalPropertyKeys {
        showCRS, styleClass, crsLabel, crsSize, minxLabel, minyLabel, maxxLabel, maxyLabel, disabled, onchange, labelColumnClass, inputColumnClass
    }
    ...
    public String getCrsLabel() {
        ...
        if ( crsLabel == null ) {
        	// error message...BY_JIN
            crsLabel = MessageUtils.getResourceText( null,
                                                     "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.renderer.InputBBoxRenderer.CRSLABEL)" );
        }
        return crsLabel;
    }
    ...
    public String getMinxLabel() {
        ...
        if ( minxLabel == null ) {
            ...
            minxLabel = MessageUtils.getResourceText( null,
                                                      "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.renderer.InputBBoxRenderer.MINXLABEL)" );
        }
        return minxLabel;
    }
    ...
    public String getMinyLabel() {
        ...
        if ( minyLabel == null ) {
            ...
            minyLabel = MessageUtils.getResourceText( null,
                                                      "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.renderer.InputBBoxRenderer.MINYLABEL)" );
        }
        return minyLabel;
    }
    ...
    public String getMaxxLabel() {
        ...
        if ( maxxLabel == null ) {
            ...
            maxxLabel = MessageUtils.getResourceText( null,
                                                      "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.renderer.InputBBoxRenderer.MAXXLABEL)" );
        }
        return maxxLabel;
    }
    ...
    public String getMaxyLabel() {
        ...
        if ( maxyLabel == null ) {
            ...
            maxyLabel = MessageUtils.getResourceText( null,
                                                      "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.renderer.InputBBoxRenderer.MAXYLABEL)" );
        }
        return maxyLabel;
    }
    ...
    public BBox getValue() {
        ...
        if ( !( value instanceof BBox ) ) {
            ...
            throw new FacesException( "입력박스는 반드시 BBox 타입이어야 합니다." );
        }
    ...
    protected void validateValue( FacesContext context, Object value ) {
        ...
        if ( isRequired() && isBBoxEmpty( value ) ) {
            ...
            FacesMessage message = MessageUtils.getFacesMessage( FacesMessage.SEVERITY_ERROR,
                                                                 "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.component.HtmlInputBBox.REQUIRED)",
                                                                 getClientId() );
        ...
        if ( isShowCRS() && bbox.getCrs() == null ) {
        	// error message...BY_JIN
            FacesMessage message = MessageUtils.getFacesMessage( FacesMessage.SEVERITY_ERROR,
                                                                 "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.component.HtmlInputBBox.INVALID_CRS)",
                                                                 getClientId() );
            context.addMessage( getClientId( context ), message );
            setValid( false );
        }
        if ( Double.isNaN( bbox.getMinx() ) ) {
        	// error message...BY_JIN
            FacesMessage message = MessageUtils.getFacesMessage( FacesMessage.SEVERITY_ERROR,
                                                                 "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.component.HtmlInputBBox.INVALID_MINX)",
        ...
        if ( Double.isNaN( bbox.getMinY() ) ) {
        	// error message...BY_JIN
            FacesMessage message = MessageUtils.getFacesMessage( FacesMessage.SEVERITY_ERROR,
                                                                 "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.component.HtmlInputBBox.INVALID_MINY)",
        ...
        if ( Double.isNaN( bbox.getMaxX() ) ) {
        	// error message...BY_JIN
            FacesMessage message = MessageUtils.getFacesMessage( FacesMessage.SEVERITY_ERROR,
                                                                 "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.component.HtmlInputBBox.INVALID_MAXX)",
        ...
        if ( Double.isNaN( bbox.getMaxY() ) ) {
        	// error message...BY_JIN
            FacesMessage message = MessageUtils.getFacesMessage( FacesMessage.SEVERITY_ERROR,
                                                                 "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.component.HtmlInputBBox.INVALID_MAXY)",
        ...
        if ( bbox.getMaxX() < bbox.getMinx() || bbox.getMaxY() < bbox.getMaxY() ) {
        	// error message...BY_JIN
            FacesMessage message = MessageUtils.getFacesMessage( FacesMessage.SEVERITY_ERROR,
                                                                 "데이터 처리 중 오류가 발생하였습니다(오류위치 : org.deegree.client.core.component.HtmlInputBBox.INVALID_BBOX)",
