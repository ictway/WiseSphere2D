...
public abstract class AbstractWFSRequestKVPAdapter {
    ...
    protected static Map<String, String> extractNamespaceBindings110( Map<String, String> kvpUC )
        ...
        if ((nsString == null)||(nsString.isEmpty()))
        	nsString = "xmlns(gml=\"http://www.opengis.net/gml)";
        	//nsString = "xmlns(app=http://www.deegree.org/app),xmlns(gml=\"http://www.opengis.net/gml),xmlns(http://www.opengis.net/ogc)";
