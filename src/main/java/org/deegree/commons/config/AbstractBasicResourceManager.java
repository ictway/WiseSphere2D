...
//    protected Map<String, ResourceState> idToState = Collections.synchronizedMap( new TreeMap<String, ResourceState>(String.CASE_INSENSITIVE_ORDER) ); // BY_JIN
...
// BY_JIN        
      if ( idToState.containsKey( id ) ) {
        ...
        // BY_JIN --
//        Iterator it = idToState.entrySet().iterator();
//        
//        while(it.hasNext()) {
//        	Map.Entry pair = (Map.Entry)it.next();
//        	String tempId = (String)pair.getKey();
//        	if (tempId.toUpperCase().equals(id.toUpperCase()) ) {
//                String msg = "Cannot create resource '" + id + "' (" + this.getClass().getSimpleName() + "). Resource already exists.";
//                throw new IllegalArgumentException( msg );
//        	}
//        }
        // BY_JIN
