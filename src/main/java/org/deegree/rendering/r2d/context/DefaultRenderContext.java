...
public class DefaultRenderContext implements RenderContext {
	...
	* Content: TextRederer에서 이미지 width, height 파라미터 필요. 오버로딩 생성자 생성 + 라벨 충돌 여부 체크 parameter 추가
	*/
    public DefaultRenderContext( RenderingInfo info, Boolean isAvoidLblCollision, BitSet[] criBitMatrix) {
        ...
        textRenderer = new Java2DTextRenderer( renderer, info.getWidth(), info.getHeight(), isAvoidLblCollision, criBitMatrix);
