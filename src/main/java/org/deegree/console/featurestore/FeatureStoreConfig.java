...
public class FeatureStoreConfig implements Serializable {
    ...
    public String createTables() {
        ...
        if ( !getSql() ) {
        	// message...BY_JIN
//            FacesMessage fm = new FacesMessage( SEVERITY_ERROR, "Current feature store is not capable of creating tables.", null );
            FacesMessage fm = new FacesMessage( SEVERITY_ERROR, "현재 Feature 저장소 테이블을 만들수 없습니다.", null );
