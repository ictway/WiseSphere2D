...
//                FacesMessage fm = new FacesMessage( SEVERITY_ERROR, "Folder doesn't exists!", null );
                FacesMessage fm = new FacesMessage( SEVERITY_ERROR, "폴더가 존재하지 않습니다.", null );
            ...
            fail( file );
            // message...BY_JIN
//            FacesMessage fm = new FacesMessage( SEVERITY_ERROR, "Metadata import failed: " + t.getMessage() + " check file: " + file.getName(), null );
            FacesMessage fm = new FacesMessage( SEVERITY_ERROR, "메타 데이터를 불러올 수 없습니다(오류내용: " + t.getMessage() + " 파일명: " + file.getName() + ")", null );
            FacesContext.getCurrentInstance().addMessage( null, fm );
            return;
        }
...
//        String msgImportFail = "Failed to import " + countInsertFailed + " " + metadataRecordOut + ". " + "Ignored files are: " + failedFiles;
        // message...BY_JIN
//        FacesMessage fm1 = new FacesMessage( SEVERITY_INFO, msgImportOK, null );
        FacesMessage fm1 = new FacesMessage( SEVERITY_INFO, "메타 데이터 불러오기 성공", null );
//        FacesMessage fm2 = new FacesMessage( SEVERITY_INFO, msgImportFail, null );
        FacesMessage fm2 = new FacesMessage( SEVERITY_INFO, "메타 데이터 불러오기 실패", null );  
