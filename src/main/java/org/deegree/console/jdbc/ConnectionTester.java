...
//            FacesMessage fm = new FacesMessage( SEVERITY_INFO, "Connection '" + id + "' ok", null );
            FacesMessage fm = new FacesMessage( SEVERITY_INFO, "'" + id + "' 연결 성공", null );
            FacesContext.getCurrentInstance().addMessage( null, fm );
        } catch ( Throwable t ) {
        	// message...BY_JIN
//            FacesMessage fm = new FacesMessage( SEVERITY_ERROR, "Connection '" + id + "' unavailable: " + t.getMessage(), null );
            FacesMessage fm = new FacesMessage( SEVERITY_ERROR, "'" + id + "' 연결을 사용할 수 없습니다(오류내용: " + t.getMessage() + ")", null );
