...
public class Filter110XMLDecoder {
    ...
    public static Expression parseExpression( XMLStreamReader xmlStream )
        ...
        //@@ictway
        if (type == null) 
        	type = elementNameToExpressionType.get( new QName( OGC_NS, xmlStream.getName().getLocalPart() ) );
    ...
    public static ComparisonOperator parseComparisonOperator( XMLStreamReader xmlStream )
        ...
        //@@ ictway
        if ( type == null) 
        	type = elementNameToComparisonOperatorType.get( new QName( OGC_NS, xmlStream.getName().getLocalPart() ) );
    ...
    private static Operator parseOperator( XMLStreamReader xmlStream )
        ...
        // @@ictway
        if (type == null) {
        	type = elementNameToOperatorType.get( new QName( OGC_NS, xmlStream.getName().getLocalPart() ) );
        }
        //
    ...
    private static LogicalOperator parseLogicalOperator( XMLStreamReader xmlStream )
        ...
        // @@ictway
        if (type == null) 
        	type = elementNameToLogicalOperatorType.get( new QName( OGC_NS, xmlStream.getName().getLocalPart() ) );
    ...
    private static SpatialOperator parseSpatialOperator( XMLStreamReader xmlStream )
        ...
        // @@ictway
        if (type == null) 
        	type = elementNameToSpatialOperatorType.get( new QName( OGC_NS, xmlStream.getName().getLocalPart() ) );
