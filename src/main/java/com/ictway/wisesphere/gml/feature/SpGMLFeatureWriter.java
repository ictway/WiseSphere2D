...
package com.ictway.wisesphere.gml.feature;
 ...
 */
public class SpGMLFeatureWriter extends SpAbstractGMLObjectWriter {

    private static final Logger LOG = LoggerFactory.getLogger( SpGMLFeatureWriter.class );
     ...
     */
    public SpGMLFeatureWriter( SpGMLStreamWriter gmlStreamWriter ) {
