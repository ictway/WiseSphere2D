...
package com.ictway.wisesphere.gml.commons;
 ...
 */
public abstract class SpAbstractGMLObjectWriter {

    private static final Logger LOG = LoggerFactory.getLogger( SpAbstractGMLObjectWriter.class );

    protected final SpGMLStreamWriter gmlStreamWriter;
     ...
     */
    public SpAbstractGMLObjectWriter( SpGMLStreamWriter gmlStreamWriter ) {
