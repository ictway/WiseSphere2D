...
package com.ictway.wisesphere.gml.geometry;
...
import com.ictway.wisesphere.gml.commons.SpAbstractGMLObjectWriter;
 ...
 */
public class SpGML3GeometryWriter extends SpAbstractGMLObjectWriter implements GMLGeometryWriter {

    private static final Logger LOG = LoggerFactory.getLogger( SpGML3GeometryWriter.class );
     ...
     */
    public SpGML3GeometryWriter( SpGMLStreamWriter gmlStreamWriter ) {
