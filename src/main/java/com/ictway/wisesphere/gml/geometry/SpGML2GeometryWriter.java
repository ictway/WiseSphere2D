 ...
 */
public class SpGML2GeometryWriter extends SpAbstractGMLObjectWriter implements GMLGeometryWriter {

    private static final Logger LOG = LoggerFactory.getLogger( SpGML2GeometryWriter.class );
     ...
     */
    public SpGML2GeometryWriter( SpGMLStreamWriter gmlStream ) {
        super( gmlStream );
