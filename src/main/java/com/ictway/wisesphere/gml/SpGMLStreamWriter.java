...
/*----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
package com.ictway.wisesphere.gml;
...
import com.ictway.wisesphere.gml.geometry.SpGML2GeometryWriter;
import com.ictway.wisesphere.gml.geometry.SpGML3GeometryWriter;
 ...
 */
public class SpGMLStreamWriter {
    ...
    private SpGMLFeatureWriter featureWriter;
     ...
     */
    SpGMLStreamWriter( GMLVersion version, XMLStreamWriter xmlStream ) throws XMLStreamException {
    ...
    public SpGMLFeatureWriter getFeatureWriter() {
        if ( featureWriter == null ) {
            featureWriter = new SpGMLFeatureWriter( this );
        }
   ...
   public GMLGeometryWriter getGeometryWriter() {
        if ( geometryWriter == null ) {
            switch ( version ) {
            case GML_2: {
                geometryWriter = new SpGML2GeometryWriter( this );
                break;
            }
            case GML_30:
            case GML_31:
            case GML_32: {
                geometryWriter = new SpGML3GeometryWriter( this );
                break;
            }
            }
        }
