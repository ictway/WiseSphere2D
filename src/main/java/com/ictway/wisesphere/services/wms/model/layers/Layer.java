...
import static com.ictway.wisesphere.services.wms.MapService.prepareImage;
...
import com.ictway.wisesphere.services.jaxb.wms.BoundingBoxType;
import com.ictway.wisesphere.services.jaxb.wms.DimensionType;
import com.ictway.wisesphere.services.jaxb.wms.KeywordsType;
    ...
    protected Layer( MapService service, AbstractLayerType layer, Layer parent ) {
        ...
        if ( kwTypeList != null ) {
            for ( KeywordsType kwType : kwTypeList ) {
                com.ictway.wisesphere.services.jaxb.wms.CodeType jaxbct = kwType.getType();
                CodeType ct = null;
                if ( jaxbct != null ) {
