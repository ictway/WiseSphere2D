...
/*----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
package com.ictway.wisesphere.services.wms;
...
import com.ictway.wisesphere.services.jaxb.wms.AbstractLayerType;
import com.ictway.wisesphere.services.jaxb.wms.BaseAbstractLayerType;
import com.ictway.wisesphere.services.jaxb.wms.DynamicLayer;
import com.ictway.wisesphere.services.jaxb.wms.LayerOptionsType;
import com.ictway.wisesphere.services.jaxb.wms.ServiceConfigurationType;
import com.ictway.wisesphere.services.jaxb.wms.StatisticsLayer;
import com.ictway.wisesphere.services.wms.dynamic.LayerUpdater;
import com.ictway.wisesphere.services.wms.dynamic.PostGISUpdater;
import com.ictway.wisesphere.services.wms.dynamic.ShapeUpdater;
import com.ictway.wisesphere.services.wms.model.layers.EmptyLayer;
import com.ictway.wisesphere.services.wms.model.layers.FeatureLayer;
import com.ictway.wisesphere.services.wms.model.layers.Layer;
import com.ictway.wisesphere.services.wms.model.layers.RasterLayer;
import com.ictway.wisesphere.services.wms.model.layers.RemoteWMSLayer;
...
class MapServiceBuilder {
    ...
    private Layer parseLayer( BaseAbstractLayerType layer, final Layer parent, XMLAdapter adapter, Antialias alias,
        ...
        if ( layer instanceof AbstractLayerType ) {
            ...
            res = new com.ictway.wisesphere.services.wms.model.layers.StatisticsLayer( service, parent );
