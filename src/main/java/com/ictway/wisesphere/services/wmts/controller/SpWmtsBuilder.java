...
class SpWmtsBuilder {
    ...
    private static final Logger LOG = getLogger( SpWmtsBuilder.class );
    ...
    SpWmtsBuilder( XMLAdapter controllerConf, DeegreeWorkspace workspace ) throws ResourceInitException {
        DeegreeWMTS conf;
        try {
