...
/*----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
package com.ictway.wisesphere.services.wfs.format;
 ...
 */
public interface SpCustomFormat extends Format {
     ...
     */
    public void init( SpWebFeatureService master, Object config );
}