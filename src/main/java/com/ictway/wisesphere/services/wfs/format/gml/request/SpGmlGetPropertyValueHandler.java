...
import com.ictway.wisesphere.gml.feature.SpGMLFeatureWriter;
 ...
 */
public class SpGmlGetPropertyValueHandler extends SpAbstractGmlRequestHandler {

    private static final Logger LOG = LoggerFactory.getLogger( SpGmlGetPropertyValueHandler.class );
     ...
     */
    public SpGmlGetPropertyValueHandler( SpGmlFormat format ) {
        super( format );
    }
    ...
    public void doGetPropertyValueResult( GetPropertyValue request, HttpResponseBuffer response )
        ...
        SpQueryAnalyzer analyzer = new SpQueryAnalyzer( Collections.singletonList( request.getQuery() ),
        ...
        SpBufferableXMLStreamWriter bufferedStream = (SpBufferableXMLStreamWriter) xmlStream;
        SpWfsXlinkStrategy additionalObjects = new SpWfsXlinkStrategy( bufferedStream, localReferencesPossible,
        ...
        SpGMLFeatureWriter featureWriter = gmlStream.getFeatureWriter();
    ...
    private void writeValuesStream( GetPropertyValue request, SpQueryAnalyzer analyzer, GmlXlinkOptions resolveState,
                                    XMLStreamWriter xmlStream, int startIndex, int maxResults,
                                    TypedObjectNodeXPathEvaluator evaluator, SpGMLFeatureWriter featureWriter )
    ...
    private void writeValuesCached( GetPropertyValue request, SpQueryAnalyzer analyzer, GmlXlinkOptions resolveState,
                                    XMLStreamWriter xmlStream, int startIndex, int maxResults,
                                    TypedObjectNodeXPathEvaluator evaluator, SpGMLFeatureWriter featureWriter )
                            throws XMLStreamException, FeatureStoreException, FilterEvaluationException,
                            UnknownCRSException, TransformationException {
