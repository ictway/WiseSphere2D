...
import static com.ictway.wisesphere.services.wfs.SpWebFeatureService.getXMLResponseWriter;
 ...
 */
public class SpGmlGetGmlObjectHandler extends SpAbstractGmlRequestHandler {
     ...
     */
    public SpGmlGetGmlObjectHandler( SpGmlFormat format ) {
        super( format );
    }
    ...
    public void doGetGmlObject( GetGmlObject request, HttpResponseBuffer response )
        ...
        if ( !( xmlStream instanceof SpBufferableXMLStreamWriter ) ) {
            xmlStream = new SpBufferableXMLStreamWriter( xmlStream, getObjectXlinkTemplate( version, gmlVersion ) );
        }
        GmlXlinkStrategy strategy = new SpWfsXlinkStrategy( (SpBufferableXMLStreamWriter) xmlStream, false,
