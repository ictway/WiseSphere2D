 ...
 */
class SpGetCapabilitiesHandler extends OWSCapabilitiesXMLAdapter {

    private static Logger LOG = LoggerFactory.getLogger( SpGetCapabilitiesHandler.class );
    ...
    SpGetCapabilitiesHandler( SpWebFeatureService master, WfsFeatureStoreManager service, Version version,
    ...
    void export200()
        ...
        if ( sections == null || sections.contains( "OPERATIONSMETADATA" ) ) {
            ...
            /*
        	 * Title: OGC WFS 2.0.0 Test 수정
        	* Author: Jumgmin
        	* Date: 2016.01.19
        	* Version: Wise Shpere 1.0
        	* Content:Test를 위한 ImplementsBasicWFS 처리
        	*/
            constraints.add( new Domain( "ImplementsBasicWFS", "TRUE" ) );
//            constraints.add( new Domain( "ImplementsBasicWFS", "FALSE" ) );
            if ( enableTransactions ) {
