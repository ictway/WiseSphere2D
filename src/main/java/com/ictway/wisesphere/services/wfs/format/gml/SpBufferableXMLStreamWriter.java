 ...
 */
public class SpBufferableXMLStreamWriter implements XMLStreamWriter {

    private static Logger LOG = LoggerFactory.getLogger( SpBufferableXMLStreamWriter.class );
    ...
    public SpBufferableXMLStreamWriter( XMLStreamWriter sink, String xLinkTemplate ) {
        this.sink = sink;
    ...
    public void appendBufferedXML( SpGMLStreamWriter gmlWriter )
    ...
    private void copyAttributes( SpGMLStreamWriter gmlWriter, XMLStreamReader inStream )
