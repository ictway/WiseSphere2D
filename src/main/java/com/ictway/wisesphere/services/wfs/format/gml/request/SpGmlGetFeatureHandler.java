...
/*----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
package com.ictway.wisesphere.services.wfs.format.gml.request;

import static com.ictway.wisesphere.services.wfs.query.SpStoredQueryHandler.GET_FEATURE_BY_ID;
...
import com.ictway.wisesphere.gml.SpGMLOutputFactory;
import com.ictway.wisesphere.gml.SpGMLStreamWriter;
import com.ictway.wisesphere.services.wfs.SpWebFeatureService;
import com.ictway.wisesphere.services.wfs.format.gml.SpBufferableXMLStreamWriter;
import com.ictway.wisesphere.services.wfs.format.gml.SpGmlFormat;
import com.ictway.wisesphere.services.wfs.query.SpQueryAnalyzer;
 ...
 */
public class SpGmlGetFeatureHandler extends SpAbstractGmlRequestHandler {

    private static final Logger LOG = LoggerFactory.getLogger( SpGmlGetFeatureHandler.class );
     ...
     */
    public SpGmlGetFeatureHandler( SpGmlFormat format ) {
        super( format );
    }
    ...
    public void doGetFeatureResults( GetFeature request, HttpResponseBuffer response )
        ...
        SpQueryAnalyzer analyzer = new SpQueryAnalyzer( request.getQueries(), format.getMaster(),
        ...
        XMLStreamWriter xmlStream = SpWebFeatureService.getXMLResponseWriter( response, contentType, schemaLocation );
        xmlStream = new SpBufferableXMLStreamWriter( xmlStream, xLinkTemplate );
        ...
        SpGMLStreamWriter gmlStream = SpGMLOutputFactory.createGMLStreamWriter( gmlVersion, xmlStream );
        ...
        SpWfsXlinkStrategy additionalObjects = new SpWfsXlinkStrategy( (SpBufferableXMLStreamWriter) xmlStream,
        ...
        if ( ( (SpBufferableXMLStreamWriter) xmlStream ).hasBuffered() ) {
            ( (SpBufferableXMLStreamWriter) xmlStream ).appendBufferedXML( gmlStream );
        }
    }
    ...
    private void writeFeatureMembersStream( Version wfsVersion, SpGMLStreamWriter gmlStream, SpQueryAnalyzer analyzer,
    ...
    private void writeFeatureMembersCached( Version wfsVersion, SpGMLStreamWriter gmlStream, SpQueryAnalyzer analyzer,
                                            GMLVersion outputFormat, int maxFeatures, int startIndex,
                                            QName featureMemberEl, Lock lock )
                            throws XMLStreamException, UnknownCRSException, TransformationException,
                            FeatureStoreException, FilterEvaluationException, FactoryConfigurationError {
    ...
    private void writeBoundedBy( Version wfsVersion, SpGMLStreamWriter gmlStream, GMLVersion outputFormat, Envelope env )
                            throws XMLStreamException, UnknownCRSException, TransformationException {
    ...
    private Lock acquireLock( GetFeature request, SpQueryAnalyzer analyzer )
                            throws OWSException {
    ...
    private void writeSingleFeatureMember( SpGMLStreamWriter gmlStream, SpQueryAnalyzer analyzer,
