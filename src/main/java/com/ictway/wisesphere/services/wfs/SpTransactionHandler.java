 ...
 */
class SpTransactionHandler {

    private static final Logger LOG = LoggerFactory.getLogger( SpTransactionHandler.class );
    ...
    private final SpActionResults inserted = new SpActionResults();

    private final SpActionResults updated = new SpActionResults();

    private final SpActionResults replaced = new SpActionResults();
     ...
     * @param idGenMode
     */
    SpTransactionHandler( SpWebFeatureService master, WfsFeatureStoreManager service, Transaction request,
                        IDGenMode idGenMode ) {
        this.master = master;
    ...
    private void writeActionResults200( XMLStreamWriter xmlWriter, String elName, SpActionResults results )
                            throws XMLStreamException {
