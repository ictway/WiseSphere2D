 ...
 */
public class SpWfsXlinkStrategy implements GmlXlinkStrategy {

    private static Logger LOG = LoggerFactory.getLogger( SpWfsXlinkStrategy.class );
    ...
    private final SpBufferableXMLStreamWriter xmlStream;
    ...
    public SpWfsXlinkStrategy( SpBufferableXMLStreamWriter xmlStream, boolean localReferencesPossible,
